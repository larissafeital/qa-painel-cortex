...
const CLIENTS      = ['Volvo', 'Tramontina', 'BHP', 'Unilever Foods', 'Skechers'];
const DATA_NPS     = [10, 6, 10, 8, 9];
const DATA_IMPACTO = [9,  8, 10, 8, 8];
const DATA_ONBOARD = [10, 6, 10, 8, 9]; // null para clientes Ongoing
const DATA_RENOVACAO = ['2026-12-21', '2027-02-08', '2027-03-23', '2027-01-22', '2027-02-08']; // Skechers: via Vitally

// Médias do ciclo anterior — atualizar antes de adicionar novos clientes
// null = sem ciclo anterior (não exibe)
const PREV_AVERAGES = { onboarding: 8.5, nps: 8.5, impacto: 8.75 };
